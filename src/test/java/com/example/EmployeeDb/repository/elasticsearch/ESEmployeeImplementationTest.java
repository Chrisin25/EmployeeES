...
public class ESEmployeeImplementationTest {
    ...
    public void testFindByDesignation() {
        ...
        when(esRepo.findByDesignation("Developer")).thenReturn(employees);
    ...
    public void testFindAllByManagerId() {
        List<Employee> employees = Arrays.asList(new Employee("1" , "John Doe", "Account Manager","john@aspire.com","BA","1234567890","Kochi","0",OffsetDateTime.now()));
        when(esRepo.findAllByManagerId("0")).thenReturn(employees);
    ...
    public void testFindAllByManagerIdAndYearOfExperienceGreaterThanEqual() {
        List<Employee> employees = Arrays.asList(new Employee("1" , "John Doe", "Account Manager","john@aspire.com","BA","1234567890","Kochi","0",OffsetDateTime.now()));
        when(esRepo.findAllByManagerIdAndYearOfExperienceGreaterThanEqual("0", 0L)).thenReturn(employees);
    ...
    public void testFindAllByDesignationAndDepartment() {
        List<Employee> employees = Arrays.asList(new Employee("1" , "John Doe", "Account Manager","john@aspire.com","BA","1234567890","Kochi","0",OffsetDateTime.now()));
        when(esRepo.findAllByDesignationAndDepartment("Account Manager", "BA")).thenReturn(employees);
    ...
    public void testFindAllByDepartment() {
        List<Employee> employees = Arrays.asList(new Employee("1" , "John Doe", "Account Manager","john@aspire.com","BA","1234567890","Kochi","0",OffsetDateTime.now()));
        when(esRepo.findAllByDepartment("BA")).thenReturn(employees);
    ...
    public void testDeleteById() {
        ...
        doNothing().when(esRepo).deleteById("1");

        sqlImplementation.deleteById("1");
        verify(esRepo, times(1)).deleteById("1");
    }
    ...
    public void testSave() {
        ...
        verify(esRepo, times(1)).save(employee);
    }
}
